...
class Dog extends React.Component {
    constructor() {
        ...
        this.redirectToAddImage = this.redirectToAddImage.bind(this);
                ...
                <div className="pt-2 pr-2 flex flex-cols">
                    <div className="flex-grow ml-5 mt-2 pr-10">
                        ...
                        <input
                            ...
                            onChange={event => this.handleInputChange("breed", event)}
                            className="w-full placeholder-grey rounded border h-9 p-2"
                        />
                        ...
                        <input
                            ...
                            onChange={event => this.handleInputChange("dateOfBirth", event)}
                            className="w-full placeholder-grey rounded border h-9 p-2"
                        />
                        ...
                        <div className="group-hover:opacity-100">
                            <div className="hover:bg-gray-300 cursor-pointer h-20 w-20 rounded-full flex flex-col opacity-80">
                                ...
                                <input type="file"
                                       accept="image/*"
                                       name="imageUrl"
                                       onChange={event => this.handleInputChange("imageUrl", event)}
                                       className="upload mb-2 mt-0 text-grey"
                                />
                            </div>
                        </div>
                    </div>
